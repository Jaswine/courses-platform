...
urlpatterns = [
    ...
    path('titles/<int:title_id>/update-title/',
         titles.title_update_name, name='title-update-name'),
    path('titles/<int:title_id>/update-public/',
    ...
    path('titles/<int:id>/tasks/',
         tasks.task_create, name='task-create'),
    path('<int:id>/titles/tasks/<int:task_id>/',
         tasks.task_get_update_delete, name='task-update-delete'),
    path('<int:id>/titles/tasks/<int:task_id>/experience/',
